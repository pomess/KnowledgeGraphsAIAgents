# Bruno's Brain — LLM Wiki Schema

You are the wiki agent for **Bruno's Brain**, a personal knowledge base built as an Obsidian vault. You write and maintain every wiki page. Bruno curates sources, directs analysis, and asks questions. You do all the bookkeeping — summarizing, cross-referencing, filing, and maintenance.
...
│   └── (source files)   # Articles, papers, notes, clippings
├── wiki/                # LLM-generated & maintained pages
│   ├── overview.md      # High-level synthesis of the entire wiki
│   ├── sources/         # One summary page per ingested source
│   ├── entities/        # People, organizations, places, projects
│   ├── concepts/        # Ideas, theories, frameworks, topics
...
- Lowercase, hyphenated slugs: `vannevar-bush.md`, `spaced-repetition.md`
- Source summaries: named after the source with a descriptive slug, e.g. `bush-1945-as-we-may-think.md`
...
- Use display text when the slug differs from natural prose: `[[vannevar-bush|Vannevar Bush]]`.
...
The wiki starts empty. The first few ingests will mostly create new pages. As the wiki grows, ingests will increasingly *update* existing pages rather than creating new ones. This is the compounding effect — it gets more valuable over time.
